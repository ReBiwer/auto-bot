...
async def get_all_refuels(message: Message, refuels: dict[int, Refueling]):
...
async def detail_refueling(call: CallbackQuery, refuels: dict[int, Refueling]):
...
async def get_all_refuels(call: CallbackQuery, refuels: dict[int, Refueling]):
